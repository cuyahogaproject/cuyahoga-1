...
INSERT INTO cuyahoga_modulesetting ( moduletypeid, name, friendlyname, settingdatatype, iscustomtype, isrequired) VALUES ( currval('cuyahoga_moduletype_moduletypeid_seq'), 'MOVIENAME', 'Movie Name', 'System.String', false, true);
...
INSERT INTO cuyahoga_modulesetting ( moduletypeid, name, friendlyname, settingdatatype, iscustomtype, isrequired) VALUES ( currval('cuyahoga_moduletype_moduletypeid_seq'), 'MAJORPLUGINVERSIONREVISION', 'Major Plugin Version Revision', 'System.Int32', false, true);
INSERT INTO cuyahoga_modulesetting ( moduletypeid, name, friendlyname, settingdatatype, iscustomtype, isrequired) VALUES ( currval('cuyahoga_moduletype_moduletypeid_seq'), 'MINORPLUGINVERSION', 'Minor Plugin Version', 'System.Int32', false, true);
INSERT INTO cuyahoga_modulesetting ( moduletypeid, name, friendlyname, settingdatatype, iscustomtype, isrequired) VALUES ( currval('cuyahoga_moduletype_moduletypeid_seq'), 'MINORPLUGINVERSIONREVISION', 'Minor Plugin Version Revision', 'System.Int32', false, false);
INSERT INTO cuyahoga_modulesetting ( moduletypeid, name, friendlyname, settingdatatype, iscustomtype, isrequired) VALUES ( currval('cuyahoga_moduletype_moduletypeid_seq'), 'ALTERNATEDIVID', 'Use Alternate Div Id for Flash replacement', 'System.String', false, false);
INSERT INTO cuyahoga_modulesetting ( moduletypeid, name, friendlyname, settingdatatype, iscustomtype, isrequired) VALUES ( currval('cuyahoga_moduletype_moduletypeid_seq'), 'MOVIEVARS', 'Set any flash vars (var:value)', 'System.String', false, false);
INSERT INTO cuyahoga_modulesetting ( moduletypeid, name, friendlyname, settingdatatype, iscustomtype, isrequired) VALUES ( currval('cuyahoga_moduletype_moduletypeid_seq'), 'MOVIEPARAMS', 'Set any flash params (var:value;)', 'System.String', false, false);

INSERT INTO cuyahoga_version (assembly, major, minor, patch) VALUES ('Cuyahoga.Modules.Flash', 1, 5, 1);