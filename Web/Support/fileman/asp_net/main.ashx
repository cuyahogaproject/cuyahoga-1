...
public class RoxyFilemanHandler : IHttpHandler, System.Web.SessionState.IRequiresSessionState
{
	...
	public void ProcessRequest (HttpContext context) {
		// Cuyahoga-specific: Check authentication first
		Cuyahoga.Core.Domain.User cuyahogaUser = context.User.Identity as Cuyahoga.Core.Domain.User;
		if (cuyahogaUser == null || ! (cuyahogaUser.IsInRole("Administrator") || cuyahogaUser.IsInRole("Editor")))
		{
